@extends('include.dashboardmaster')
@section('content')

    <body class="ipsApp ipsApp_front ipsJS_has ipsClearfix" data-controller="core.front.core.app" data-message=""
        ...
        <div id="ipsLayout_header" class="ipsClearfix">
                ...
                <div class="ipsLayout_container">
                    ...
                    <ul id="elUserNav" class="ipsList_inline cSignedOut ipsResponsive_showDesktop">
                                        ...
                                        <details class='cSearchFilter'>
                                            ...
                                            <ul class='cSearchFilter__menu'>
                                                ...
                                                <li><label><input type="radio" name="type" value="all"
                                                            checked><span
                                                            class='cSearchFilter__menuText'>Everywhere</span></label></li>
                        ...
                        <li class="alerts-border" style="padding: 10px; background: #ffe60a; border-radius: 5px;">
                            <a href="https://hindi.eci.gov.in/" style="font-size:18px; color: #083e54;"><strong>हिंदी में
                                    देखें</strong></a>
                        </li>
                        <li id="elSignInLink">
            ...
            <div
                class="header1 hidden-sm-down hidden-sm visible-lg visible-md d-none d-xl-block d-lg-block d-md-block ipsResponsive_hidePhone ipsResponsive_hideTablet ipsResponsive_showDesktop ipsResponsive_block">
                <div class="ipsLayout_container" style="background:rgba(0,0,0, 0.0)">
                    <span tabindex="0" class="menu-btn">Menu<i class="fa fa-bars" aria-hidden="true"></i></span>
                    <div class="ipsResponsive_hidePhone pull-right">
                    </div>

                    <div class="main-menu">
                        <span class="menu-btn pull-right close-menu"><i class="fa fa-window-close"
                        ...
                        <div class="af_Content">
                            ...
                            <section class='ipsType_normal ipsType_richText ipsType_break'>
                                <ul class='af_quicklinks'
                                    ...
                                    <li><a href='https://www.nvsp.in/' class='ipsTruncate ipsTruncate_line'
                                            target='blank' title="Apply for Voter Card">Apply for Voter Card</a></li>
                                    <li><a href='https://eci-citizenservices.eci.nic.in/'
                                            class='ipsTruncate ipsTruncate_line' target='blank'
                                            title="Public Grievance">Public Grievance</a></li>
                                    <li><a href='https://rti.eci.nic.in' class='ipsTruncate ipsTruncate_line'
                                            target='blank' title="RTI Online">RTI Online</a></li>
                            ...
                            <section class='ipsType_normal ipsType_richText ipsType_break'>
                                <ul class='af_quicklinks'
                                    ...
                                    <li><a href='/files/category/8-compendium-of-instructions/'
                                            ...
                                            title="Compendium of Instructions">Compendium of Instructions</a></li>
                                    <li><a href='/files/category/112-eci-publication/'
                                            class='ipsTruncate ipsTruncate_line'
                    ...
                    <div class='ipsColumn af_quicklinksCol af_quicklinksCol_10'>
                        <div class="af_Content">
                            ...
                            <section class='ipsType_normal ipsType_richText ipsType_break'>
                                <ul class='af_quicklinks'
                                    style='-webkit-column-count: 2;-moz-column-count: 2;column-count: 2;'>
                                    <li><a href='http://ecisveep.nic.in/' class='ipsTruncate ipsTruncate_line'
                                            target='blank' title="SVEEP">SVEEP</a></li>
                                    ...
                                    <li><a href='/contact-us/directory/' class='ipsTruncate ipsTruncate_line'
                                            target='blank' title="Officers Directory">Officers Directory</a></li>
                                    <li><a href='/contact-us/contact-us/' class='ipsTruncate ipsTruncate_line'
                                            target='blank' title="Contact Us">Contact Us</a></li>
                                </ul>
                            </section>
                        </div>
                    </div>
                ...
                <ul id='elFooterSocialLinks' class='ipsList_inline ipsType_center ipsSpacer_top'>
                    ...
                    <li class='cUserNav_icon'>
                        <a href='https://www.instagram.com/ecisveep/' target='_blank'
                            class='cShareLink cShareLink_instagram' rel='noopener noreferrer' title='instagram'><i
                ...
                <ul class='ipsList_inline ipsType_center ipsSpacer_top' id="elFooterLinks">
                    <li>
                        ...
                        <ul id='elNavTheme_menu' class='ipsMenu ipsMenu_selectable ipsHide'>
                            ...
                            <li class='ipsMenu_item'>
                                <form action="//eci.gov.in/theme/?csrfKey=c4f6c1e7a1dc2b7673f39e1972396267"
                                    method="post">
                                    <input type="hidden" name="ref" value="aHR0cHM6Ly9lY2kuZ292LmluLw==">
                                    <button type='submit' name='id' value='25'
